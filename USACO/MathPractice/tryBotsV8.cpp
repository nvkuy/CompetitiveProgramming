...
/*
    ...
    also because (n + x + 1)C(x + 1) = (n + x + 1)Cn
    => ans = (n + x + 1)Cn for 0 <= x <= n
    add nCn to both side => ans + nCn = (n + x + 1)Cn for -1 <= x <= n
    => ans = (2n + 2)C(n + 1) - 1 (Hockey Stick Identity)
